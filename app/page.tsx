...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f7f2ea] text-neutral-900">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-0 py-16">
        <div className="overflow-hidden md:min-h-[500px]">
          <div
            ...
            {slides.map((slide) => (
              ...
              >
                <div className="relative mx-auto flex h-[320px] w-[320px] items-center justify-center sm:h-[380px] sm:w-[380px]">
                  ...
                  <div className="absolute -top-10 left-1/2 z-20 -translate-x-1/2 sm:w-[450px] rotate-[-30deg] min-w-[100vw] top-[20px] md:min-w-[410px]">
                    <Image
                      src={slide.image}
                      alt={slide.title}
                      width={800}
                  ...
                  <div className="absolute -right-10 top-5 h-24 w-24 rounded-2xl border bg-white/60 backdrop-blur animate-float" />
                  <div className="absolute -left-8 -bottom-10 h-12 w-28 rounded-full border bg-white/70 backdrop-blur animate-drift" />
                ...
                <div className="space-y-6 lg:pl-6 px-6 mt-[70px] lg:mt-0">
                  <div className="inline-flex items-center gap-2 rounded-full border bg-white/60 px-4 py-2 text-xs uppercase tracking-[0.3em]">
                    {slide.label}
                  </div>
        ...
        <div className="mt-10 flex items-center gap-4 text-sm text-neutral-600 px-6">
          {slides.map((slide) => (
            <button
              key={slide.id}
              type="button"
              ...
              className={`h-[8px] rounded-md transition-all ${
                activeSlide === slide.id
                  ? "w-16 bg-red-500/90 hover:bg-red-500"
                  : "w-8 bg-red-300/70 hover:bg-red-500"
              }`}
            />
          ))}
